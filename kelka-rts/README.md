...
- Kelka Egg Incubator (now player-constructed, up to 2) and Garden Heart (win condition) buildings. Any building can be repaired for coins once damaged. All four buildings render as custom "Kelka Industries" branded artwork (`public/buildings/`) rather than emoji glyphs, with a team-colored backdrop so player and AI structures stay distinguishable.
